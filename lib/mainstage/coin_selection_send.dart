...
class CoinSelectionPageSend extends StatelessWidget {
  CoinSelectionPageSend({super.key});
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            onTap: () {
              if (index == int.parse(swapController.receiveCoin.value)) {
                Get.snackbar(
                  "Error",
                  "",
                ...
                swapController.updateSendCoin(index);
                Get.offAll(() => Homepage());
              }
            },
          );
